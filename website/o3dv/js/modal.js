...
OV.ProgressDialog = class extends OV.Dialog {
    ...
    Init(text) {
        ...
        if (width < 400) {
            $(
                '<svg style="height: auto; width: auto; max-width: 600px; max-height: 600px;"><use href="assets/images/3dviewer_net_logo.svg#logo"></use></svg>'
            ).addClass('ov_progress_img').appendTo(contentDiv);
        } else if (width < 768) {
            $(
                '<svg style="height: auto; width: auto; max-width: 300px; max-height: 300px;"><use href="assets/images/3dviewer_net_logo.svg#logo"></use></svg>'
            ).addClass('ov_progress_img').appendTo(contentDiv);
        } else {
            $(
