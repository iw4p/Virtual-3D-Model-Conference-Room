...
OV.Viewer = class {
    ...
    InitCamera() {
        ...
        let socket = this.parameters;
        // console.log('socket :D');
        // console.log(socket);
        this.navigation = new OV.Navigation(canvasElem, camera, socket, this);
        ...
        //todo
        // this.navigation.SetMyCamera(this.camera, this.renderer, this.scene);

    }

    SetLoadingModelViewer(loading) {
        this.navigation.SetLoadingModelNavigation(loading);
    }
